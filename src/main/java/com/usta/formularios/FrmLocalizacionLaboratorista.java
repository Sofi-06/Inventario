...
import static com.usta.formularios.FrmLocalizacionDirector.setImageToLabel;
...
public class FrmLocalizacionLaboratorista extends javax.swing.JFrame {

    FontIcon iconoUsuario = new FontIcon();

    public FrmLocalizacionLaboratorista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 70, -1, -1));
        ...
        jPanel1.add(panelUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 60, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLocalizacionLaboratorista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmLocalizacionLaboratorista().setVisible(true);
            }
        });
    }
