...
public class FrmRegistrarConsumibles extends javax.swing.JFrame {
    ...
    public FrmRegistrarConsumibles() {
        initComponents();
        ...
        try {
            ...
            Image imageIconSpotify = new ImageIcon(imageUrl).getImage().getScaledInstance(50, 50, 0);
            ImageIcon iconoSpo = new ImageIcon(imageIconSpotify);
            // crea un Jlabel y asigna el ImageIcon
            lblFoto.setIcon(iconoSpo);
    ...
    private void initComponents() {
        ...
        lblGabinete.setText("NUMERO DE GABINETE");
    ...
    private void btnAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAñadirActionPerformed
        if (estaTodoBien()) {
            ...
            Consumible objConsu = new Consumible();

            objConsu.setNombreConsumible(nombre);
            objConsu.setMarcaConsumible(marca);
            objConsu.setObservacionConsumible(observaciones);
            objConsu.setReferenciaConsumible(referencia);
            objConsu.setCantidadConsumible(cantidad);
            objConsu.setNumeroGabineteConsumible(gabinete);
            objConsu.setFotoConsumible(rutaAplicacion);

            DaoConsumible miDao = new DaoConsumible();
            if (miDao.registrar(objConsu)) {
                JOptionPane.showMessageDialog(panelCuerpo, "¡¡Registro exitoso!!", "Informacion", JOptionPane.INFORMATION_MESSAGE);
            } else {
    ...
    private void lblFotoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblFotoMouseClicked
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            lblFoto.setIcon(new ImageIcon(imagen.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH)));
        }

        FrmVisualizarConsumiblesLab visualizar = new FrmVisualizarConsumiblesLab();
        if (rutaAplicacion != null && !rutaAplicacion.isEmpty()) {
            visualizar.agregarImagenATabla(rutaAplicacion);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarConsumibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRegistrarConsumibles().setVisible(true);
            }
        });
    }
