...
public class FrmVisualizarConsumiblesLab extends javax.swing.JFrame {
    ...
    public FrmVisualizarConsumiblesLab() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVisualizarConsumiblesLab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVisualizarConsumiblesLab().setVisible(true);
            }
        });
    }
