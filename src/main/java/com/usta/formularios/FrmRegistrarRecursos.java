...
public class FrmRegistrarRecursos extends javax.swing.JFrame {

    FontIcon iconoUsuario = new FontIcon();
    FontIcon iconoInicio = new FontIcon();

    public FrmRegistrarRecursos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAñadir.setText("AÑADIR RECURSO");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(panelCuerpo, javax.swing.GroupLayout.PREFERRED_SIZE, 1198, Short.MAX_VALUE)
        );
    ...
    private void btnAñadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAñadirActionPerformed
        if (estaTodoBien()) {
            ...
            objElemento.setNombreElemento(nombre);
            objElemento.setInventarioElemento(codInv);
            objElemento.setCantidadElemento(cantidad);
            objElemento.setReferenciaElemento(referencia);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarRecursos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmRegistrarRecursos().setVisible(true);
            }
        });
    }
