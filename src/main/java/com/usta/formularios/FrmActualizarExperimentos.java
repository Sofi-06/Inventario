...
public class FrmActualizarExperimentos extends javax.swing.JFrame {

    FontIcon iconoUsuario = new FontIcon();
    FontIcon iconoInicio = new FontIcon();

    Integer seleccionarBuscar = 0;
    private Integer codExperimento = null;
    private String titulos[] = {"Código", "Nombre", "Código Inventario", "Accesorios", "Cantidad", "Foto", "Manual", "Acta", "Costo", "Fecha de compra", "Eliminar", "Editar"};
    ...
    public FrmActualizarExperimentos() {
        initComponents();
    ...
    private void cargarRompe(String ordencito) {
        ...
        arrRompe.forEach((rompe) -> {
            ...
            if (rompe.getCodExperimento().getManualExperimento()) {
                filita[6] = "Si";
            } else {
                filita[6] = "No";
            }
            ...
            // Verificar que fecha no sea nula
        ...
        tblDatos.getColumnModel().getColumn(5).setCellRenderer(new FrmActualizarExperimentos.ImageRenderer());
...
//    }
    ...
    private boolean siElimino(Integer codigoRecursos) {
        ...
        DaoExperimento miDao = new DaoExperimento();
        Experimento objElemento = miDao.buscar(codigoRecursos);

        opcion = JOptionPane.showOptionDialog(panelCuerpo, "¿Esta seguro de eliminar el experimento: " + objElemento.getNombreExperimento()
    ...
    private void initComponents() {
        ...
        panelUsuarioLayout.setHorizontalGroup(
            ...
            .addComponent(lblUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 62, Short.MAX_VALUE)
        );
        panelUsuarioLayout.setVerticalGroup(
            panelUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblUsuario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)
        );
        ...
        panelInicioLayout.setHorizontalGroup(
            ...
            .addComponent(lblInicio, javax.swing.GroupLayout.DEFAULT_SIZE, 68, Short.MAX_VALUE)
        );
                ...
                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelCuerpoLayout.createSequentialGroup()
                    ...
                    .addGroup(panelCuerpoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(panelCuerpoLayout.createSequentialGroup()
                            ...
                            .addComponent(txtBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 1093, javax.swing.GroupLayout.PREFERRED_SIZE)))))
        );
        panelCuerpoLayout.setVerticalGroup(
            ...
            .addGroup(panelCuerpoLayout.createSequentialGroup()
                ...
                .addGroup(panelCuerpoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(panelCuerpoLayout.createSequentialGroup()
                        .addComponent(panelInicio, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(10, 10, 10)))
                .addGap(6, 6, 6)
                .addGroup(panelCuerpoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelCuerpoLayout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(cmbFiltro, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void tblDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDatosMouseClicked
        ...
        if (columnaEliminar == 10) {
            ...
            codExperimento = Integer.valueOf(codTexto);
            DaoExperimento miDao = new DaoExperimento();
            Experimento objExp = miDao.buscar(codExperimento);

            if (objExp == null) {
                JOptionPane.showMessageDialog(panelCuerpo, "No se encontró el experimento", "Advertencia", JOptionPane.WARNING_MESSAGE);
            } else {

                if (siElimino(codExperimento)) {
                    DaoExperimento daoElim = new DaoExperimento();
                    if (daoElim.eliminar(codExperimento)) {
                        cargarRompe("");
                        JOptionPane.showMessageDialog(panelCuerpo, "Eliminación Exitosa", "Información", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(panelCuerpo, "No se pudo eliminar el experimento", "Información", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }
        ...
        if (columnaEliminar == 11) {

            int filaSeleccionada = tblDatos.getSelectedRow();
            String codigoTexto = miModeloTabla.getValueAt(filaSeleccionada, 0).toString();
            codExperimento = Integer.valueOf(codigoTexto);

            DaoExperimento miDao = new DaoExperimento();
            Experimento objExp = miDao.buscar(codExperimento);

            FrmEditarExperimentos ventanaFlotante = new FrmEditarExperimentos(objExp);
...
//        buscarDato("%" + txtBuscar.getText().toUpperCase() + "%", campoSelect);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmActualizarExperimentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmActualizarExperimentos().setVisible(true);
            }
        });
    }
