...
public class FrmVisualizarRecursosDir extends javax.swing.JFrame {
    ...
    public FrmVisualizarRecursosDir() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVisualizarRecursosDir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVisualizarRecursosDir().setVisible(true);
            }
        });
    }
