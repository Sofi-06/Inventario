...
public class FrmVisualizarExperimentosDir extends javax.swing.JFrame {
    ...
    public FrmVisualizarExperimentosDir() {
        initComponents();
...
//        centrado.setHorizontalAlignment(JLabel.CENTER);
 ...
 private void buscarDato(String dato, String campo) {
    ...
    miModeloTabla.setNumRows(0); // Limpiar la tabla
...
private String campoBuscar(int select) {
    switch (select) {
        case 0:
            return "x.id_experimento";
        case 1:
            return "x.nom_experimento";
        case 2:
            return "x.marca";
        case 3:
            return "x.cod_inventario";
        default:
    ...
    private void initComponents() {
        ...
        panelUsuarioLayout.setVerticalGroup(
            panelUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblUsuario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 58, Short.MAX_VALUE)
        );
    ...
    private void tblDatosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblDatosKeyReleased
        String textoBusqueda = txtBuscar.getText();
            String campoBusqueda = campoBuscar(cmbFiltro.getSelectedIndex()); // Asegúrate de tener un ComboBox para seleccionar el campo
            buscarDato(textoBusqueda, campoBusqueda);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVisualizarExperimentosDir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmVisualizarExperimentosDir().setVisible(true);
            }
        });
    }
